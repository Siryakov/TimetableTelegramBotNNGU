package com.siryakov.TimetableTelegramBotNNGU.bot;

import com.siryakov.TimetableTelegramBotNNGU.exception.ServiceException;
import com.siryakov.TimetableTelegramBotNNGU.service.ExchangeRatesService;
...
public class ExchangeRatesBot extends TelegramLongPollingBot {
    ...
    private static final Logger LGG = LoggerFactory.getLogger(ExchangeRatesBot.class);
    ...
    private void usdCommand(Long chatId){
        ...
        try {
            ...
            var text = "Курс доллара на %s состовляет %s рублей";
            formattedText = String.format(text, LocalDate.now(), usd);
        } catch (ServiceException e) {
            LGG.error("Ошибка получения курса долара", e);
            formattedText = "Не удалось получить текущий курс долара. Попробуйте позже.";
    ...
    private void eurCommand(Long chatId){
        ...
        try {
            ...
            var text = "Курс евро на %s состовляет %s рублей";
    ...
    private void sendMessage(Long chatId, String text) { //метод отправки сообщений
        var chatIdStr = String.valueOf(chatId);
        var sendMessage = new SendMessage(chatIdStr,text);
        try {
            execute(sendMessage);
        } catch (TelegramApiException e){
            LGG.error("Ошибка отправки сообщения", e);
        }
    }
